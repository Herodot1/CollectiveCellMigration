...
do_corr2 = 0; %set to zero to disable calculation of correlation map to save time
if repeat == 0
...
%sum(sum(sum(result_conv-result_conv2)))./sum(sum(sum(result_conv)))
...
if repeat == 1 && passes == 1
    ...
    %GPU computing performance test
%     image1_cutB_gpu=gpuArray(image1_cutB);
%     image2_cutB_gpu=gpuArray(image2_cutB);
%     result_convB_gpu = fftshift(fftshift(real(ifft2(conj(fft2(image1_cutB_gpu)).*fft2(image2_cutB_gpu))), 1), 2);
%     result_conv2B=gather(result_convB_gpu);
%     result_convB=result_conv2B;
    ...
    %GPU computing performance test
%     image1_cutC_gpu=gpuArray(image1_cutC);
%     image2_cutC_gpu=gpuArray(image2_cutC);
%     result_convC_gpu = fftshift(fftshift(real(ifft2(conj(fft2(image1_cutC_gpu)).*fft2(image2_cutC_gpu))), 1), 2);
%     result_conv2C=gather(result_convC_gpu);
%     result_convC=result_conv2C;
    ...
    %GPU computing performance test
%     image1_cutD_gpu=gpuArray(image1_cutD);
%     image2_cutD_gpu=gpuArray(image2_cutD);
%     result_convD_gpu = fftshift(fftshift(real(ifft2(conj(fft2(image1_cutD_gpu)).*fft2(image2_cutD_gpu))), 1), 2);
%     result_conv2D=gather(result_convD_gpu);
%     result_convD=result_conv2D;
    ...
    %GPU computing performance test
%     image1_cutE_gpu=gpuArray(image1_cutE);
%     image2_cutE_gpu=gpuArray(image2_cutE);
%     result_convE_gpu = fftshift(fftshift(real(ifft2(conj(fft2(image1_cutE_gpu)).*fft2(image2_cutE_gpu))), 1), 2);
%     result_conv2E=gather(result_convE_gpu);
%     result_convE=result_conv2E;
...
%             image1_cut_gpu=gpuArray(image1_cut);
%             image2_cut_gpu=gpuArray(image2_cut);
%             result_convB_gpu = fftshift(fftshift(real(ifft2(conj(fft2(image1_cut_gpu)).*fft2(image2_cut_gpu))), 1), 2);
%             result_conv2B=gather(result_convB_gpu);
%             result_convB=result_conv2B;
...
%             image1_cut_gpu=gpuArray(image1_cut);
%             image2_cut_gpu=gpuArray(image2_cut);
%             result_convC_gpu = fftshift(fftshift(real(ifft2(conj(fft2(image1_cut_gpu)).*fft2(image2_cut_gpu))), 1), 2);
%             result_conv2C=gather(result_convC_gpu);
%             result_convC=result_conv2C;
...
%             image1_cut_gpu=gpuArray(image1_cut);
%             image2_cut_gpu=gpuArray(image2_cut);
%             result_convD_gpu = fftshift(fftshift(real(ifft2(conj(fft2(image1_cut_gpu)).*fft2(image2_cut_gpu))), 1), 2);
%             result_conv2D=gather(result_convD_gpu);
%             result_convD=result_conv2D;
...
%             image1_cut_gpu=gpuArray(image1_cut);
%             image2_cut_gpu=gpuArray(image2_cut);
%             result_convE_gpu = fftshift(fftshift(real(ifft2(conj(fft2(image1_cut_gpu)).*fft2(image2_cut_gpu))), 1), 2);
%             result_conv2E=gather(result_convE_gpu);
%             result_convE=result_conv2E;
