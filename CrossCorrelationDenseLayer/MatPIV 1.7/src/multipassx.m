...
for i=1:iter-1
    ...
    if i~=iter-1
        if wins(i,1)~=wins(i+1,1)
            ...
            %X=(wins(i+1,1):((1-overlap)*2*wins(i+1,1)):sx-2*wins(i+1,1)+1+ 2*wins(i+1,1)) - wins(i+1,1)/2;
        ...
        if wins(i,2)~=wins(i+1,2)
            ...
            %Y=(wins(i+1,1):((1-overlap)*2*wins(i+1,1)):sy-2*wins(i+1,1)+1+ 2*wins(i+1,1)) - wins(i+1,1)/2;
