function [MSD,tau,D2,dt2] = RelativeDistance(Trajectory)
...
D = zeros(T, T);
D( I + T*(j-1) ) = (sum(abs( Trajectory(I,1:end-1) - Trajectory(j,1:end-1) ), 2)); % Squared distance computation in one line !
D2 = D;
