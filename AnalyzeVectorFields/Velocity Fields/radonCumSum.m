function [P,r] = radonCumSum(I,theta,n)
...
%   $Revision: 5.27.4.6 $  $Date: 2011/08/09 17:51:40 $

narginchk(1, 3)
validateattributes(I,{'numeric','logical'},{'nonsparse'},mfilename,'I',1);

if (nargin < 2)
    theta = 0:179;
else
    %this is also checked by mex file
    validateattributes(theta,{'double'},{'nonsparse'},mfilename,'THETA',2); 
end
